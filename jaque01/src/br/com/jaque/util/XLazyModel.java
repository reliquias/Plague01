...
public class XLazyModel extends LazyDataModel<Object>{  
	...
	public Object getRowData(String rowKey) {
		for (Object obj : datasource) {
		    ...
		    Method method;
			try {
				if(c.getName().equals("br.com.jaque.modelo.Instituicao")){
					method = c.getMethod("get" + Utils.capitaliza("razaoSocial"));
				}else if(c.getName().equals("br.com.jaque.modelo.Produto")){
						method = c.getMethod("get" + Utils.capitaliza("sku"));
				}else if(c.getName().equals("br.com.jaque.modelo.Doacao")){
					method = c.getMethod("get" + Utils.capitaliza("numeroNf"));
				}else{
